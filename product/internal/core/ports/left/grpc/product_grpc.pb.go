...
type ProductServiceClient interface {
	...
	ListProducts(ctx context.Context, in *Void, opts ...grpc.CallOption) (*ListProductsResponse, error)
}
...
func (c *productServiceClient) ListProducts(ctx context.Context, in *Void, opts ...grpc.CallOption) (*ListProductsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ProductServiceServer interface {
	...
	ListProducts(context.Context, *Void) (*ListProductsResponse, error)
...
func (UnimplementedProductServiceServer) ListProducts(context.Context, *Void) (*ListProductsResponse, error) {
...
func _ProductService_ListProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).ListProducts(ctx, req.(*Void))
	}
	return interceptor(ctx, in, info, handler)
}
